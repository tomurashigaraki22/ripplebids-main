    ...
    <section className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white px-6 py-10">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold mb-8">
            <span className="text-green-400 glow-text glow-text">Welcome To RippleBids!</span>
          </h1>

          <div className="max-w-4xl mx-auto mb-12 p-8 rounded-2xl border-2 border-green-500/30 bg-black/50 backdrop-blur-sm">
            <h2 className="text-2xl sm:text-3xl font-bold text-green-400 glow-text mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 text-left">
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-semibold text-green-400 glow-text">XRPB on XRPL EVM Sidechain:</p>
                    <p className="text-gray-300 text-sm">
                      ...
                      <Link href="https://xrise33.com" className="text-green-400 glow-text hover:underline">
                        Xrise33.com
                      </Link>
                    </p>
                  </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <p className="font-semibold text-green-400 glow-text">XRPB-SOL on Solana:</p>
                    <p className="text-gray-300 text-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            ...
            <Link href="/whitepaper">
              <Button
                variant="outline"
                size="lg"
                className="border-green-500 text-green-400 glow-text hover:bg-green-500/10 px-8 py-4 text-lg bg-transparent"
              >
                Read Whitepaper
              </Button>
            </Link>
          ...
          <p className="text-sm text-gray-400 mb-8">
            Learn more in our{" "}
            <Link href="/whitepaper" className="text-green-400 glow-text hover:underline">
              Whitepaper
            </Link>{" "}
            or contact{" "}
            <Link href="mailto:support@ripplebids.com" className="text-green-400 glow-text hover:underline">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-green-500/5">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-16 text-green-400 glow-text">Why Choose XRPB?</h2>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-2xl border border-green-500/20 bg-black/30 backdrop-blur-sm">
              <Zap className="h-12 w-12 text-green-400 glow-text mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-4 text-green-400 glow-text">Lightning Fast</h3>
            ...
            <div className="text-center p-8 rounded-2xl border border-green-500/20 bg-black/30 backdrop-blur-sm">
              <Shield className="h-12 w-12 text-green-400 glow-text mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-4 text-green-400 glow-text">Secure & Reliable</h3>
              <p className="text-gray-300">
            ...
            <div className="text-center p-8 rounded-2xl border border-green-500/20 bg-black/30 backdrop-blur-sm">
              <Globe className="h-12 w-12 text-green-400 glow-text mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-4 text-green-400 glow-text">Cross-Chain Power</h3>
              <p className="text-gray-300">
