  ...
  return (
    <section className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-black to-gray-900">
      <div className="max-w-5xl mx-auto bg-black/60 border border-green-500/20 backdrop-blur-md p-8 rounded-2xl shadow-lg">
        <h1 className="text-4xl font-bold text-green-400 glow-text mb-6">Who We Are at RippleBids</h1>
        ...
        <h2 className="text-2xl font-semibold text-green-400 glow-text mb-4">Our Story</h2>
        ...
        <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
          <li><span className="text-green-400 glow-text font-semibold">Save Money:</span> Fees of 1.5–3.5% vs. Amazon’s 8–15% or eBay’s 13%+.</li>
          <li><span className="text-green-400 glow-text font-semibold">Feel Secure:</span> Escrow guarantees delivery; blockchain ensures authenticity.</li>
          <li><span className="text-green-400 glow-text font-semibold">Be Empowered:</span> Trade globally with just an XRPL wallet like Xaman.</li>
        </ul>

        <div className="border-t border-green-400 my-6" />

        <h2 className="text-2xl font-semibold text-green-400 glow-text mb-4">Why Trust Us?</h2>
        <p className="text-gray-300 text-lg leading-relaxed mb-4">
        ...
        <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
          <li><span className="text-green-400 glow-text font-semibold">Immutable Ledger:</span> 150+ XRPL validators secure every transaction.</li>
          <li><span className="text-green-400 glow-text font-semibold">Secure Funds:</span> 5/5 multi-sig wallet via Xaman and XRPL Toolkit.</li>
          <li><span className="text-green-400 glow-text font-semibold">Open Process:</span> Community-driven hiring and governance.</li>
        </ul>

        <div className="border-t border-green-400 my-6" />

        <h2 className="text-2xl font-semibold text-green-400 glow-text mb-4">Meet Our Board</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {[
            ...
            >
              ...
              />
              <h3 className="text-green-400 glow-text font-bold">{member.name}</h3>
        ...
        <p className="text-gray-300 mt-6 text-center">
          We’re expanding! Email <a href="/contact-html" className="text-green-400 glow-text underline">Ripplebids@outlook.com</a> to join us.
        </p>

        <div className="border-t border-green-400 my-6" />

        <h2 className="text-2xl font-semibold text-green-400 glow-text mb-4">Our Vision</h2>
        <p className="text-gray-300 text-lg leading-relaxed mb-6">
